...
namespace com.bhambhoo.fairludo
{
    public class Constants : MonoBehaviour
    {
        ...
        public string[] BotNames = { "Bot Martin", "Bot Robert" ,"Bot Alex","Bot Haden"};
        ...
        // Related to Token
        public PlayerToken playerToken, redPlayerToken, greenPlayerToken, yellowPlayerToken, bluePlayerToken;
        ...
        public PlayerToken GetplayerToken(byte playerIndex)
        {
            switch (playerIndex)
            {
                case 1:
                ...
                case 3:
                    return greenPlayerToken;
                case 4:
                    return yellowPlayerToken;
                default:
                    return bluePlayerToken;
            }
        }
